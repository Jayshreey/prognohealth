                        ...
                        <div class="col-md-3">
                            <div class="row">
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <?php echo app_file_manager('image','image',1,isset($team['image']) && $team['image'] != '' ? $team['image'] : ''); ?>
                                </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group text-left">
                                        ...
                                        <input class="form-control txt-submit" name="name" placeholder="{{ translate('Enter Name') }}" type="text" tabindex="1" value="{{ isset($team['name']) && $team['name'] != '' ? $team['name'] : ''  }}" required>
                                    </div>
                                </div>
                                    @php
                                    ...
                                    <div class="form-group text-left">
                                        ...
                                        <select name="is_active" class="form-control select2-modal" data-parsley-errors-container="#error_status" tabindex="2" required>
                                            @if(isset($status_list) && !empty($status_list))
                                                ...
                                                @php $selected = isset($team['is_active']) && $team['is_active'] == $key ? 'selected' : ''  @endphp
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group text-left">
                                        ...
                                        <input class="form-control txt-submit" name="position" placeholder="{{ translate('Enter Position') }}" type="text" value="{{ isset($team['position']) && $team['position'] != '' ? $team['position'] : ''  }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group text-left">
                                    <label>{{ translate('Short description') }}</label>
                                    <textarea class="form-control" name="short_description" placeholder="{{ translate('Enter Short Description') }} " >{{ isset($team['short_description']) && $team['short_description'] != '' ? $team['short_description'] : ''  }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
