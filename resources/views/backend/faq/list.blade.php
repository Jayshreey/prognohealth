@extends('backend.app')
@section('page_title'){{ translate('Faq List') }}@endsection
@section('style_files')
...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('Faq List') }}</h2>
            <ol class="breadcrumb">
		...
		<div class="btn btn-list">
			@if(valid_session('faq','add',false))
				<a class="btn ripple popup-page btn-primary" href="{{ route('admin.faq.new') }}"><i class="fe fe-plus-circle ml-2"></i> {{ translate('Add New') }}</a>
			@endif
		</div>
    </div>
		...
		$(document).ready(function () {
			$('.data-list-table').DataTable({
				...
				"columns": [
					...
					{"data": "question", orderable: false, className: 'text-center'},
