   ...
   <form action="{{ $page_action }}" method="post" class="data-parsley-validate"  data-block_form="true">
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document"> 
         <div class="modal-content">
            ...
            @php
               $role_data['faq'] = array('list','add','edit');
               $role_data['tool'] = array('list','add','edit');
               $role_data['review'] = array('list','add','edit');
               $role_data['faq_category'] = array('list','add','edit');
               $role_data['blog'] = array('list','add','edit');
               $role_data['slider'] = array('list','add','edit');
               $role_data['product'] = array('list','add','edit');
               $role_data['gallery'] = array('list','add','edit');
               $role_data['category'] = array('list','add','edit');
               $role_data['blog_category'] = array('list','add','edit');
               $role_data['gallery_category'] = array('list','add','edit');
               $role_data['testimonials'] = array('list','add','edit');
               $role_data['certification'] = array('list','add','edit');
               $role_data['client'] = array('list','add','edit');
               $role_data['pages'] = array('list','add','edit');
               $role_data['team'] = array('list','add','edit');
               $role_data['role'] = array('list','add','edit');
               $role_data['filemanager'] = array('filemanager');
               $role_data['user'] = array('list','add','edit','password','2FA');
               $role_data['settings'] = array('basic','theme','security');
            @endphp
            <div class="row">
