                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="form-group text-left">
                                ...
                                <?php echo app_file_manager('image','image',1,isset($client['image']) && $client['image'] != '' ? $client['image'] : ''); ?>
                            </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group text-left">
                                    ...
                                    <input class="form-control txt-submit" name="name" placeholder="{{ translate('Enter Name') }}" type="text" tabindex="1" value="{{ isset($client['name']) && $client['name'] != '' ? $client['name'] : ''  }}" required>
                                </div>
                            </div>
                                @php
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <select name="is_active" class="form-control select2-modal" data-parsley-errors-container="#error_status" tabindex="2" required>
                                        @if(isset($status_list) && !empty($status_list))
                                            ...
                                            @php $selected = isset($client['is_active']) && $client['is_active'] == $key ? 'selected' : ''  @endphp
