@extends('backend.app')
@section('page_title'){{ translate('Review List') }}@endsection
...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('Review List') }}</h2>
            <ol class="breadcrumb">
		...
		<div class="btn btn-list">
			@if(valid_session('review','add',false))
				<a class="btn ripple popup-page btn-primary" href="{{ route('admin.review.new') }}"><i class="fe fe-plus-circle ml-2"></i> {{ translate('Add New') }}</a>
			@endif
		</div>
    </div>
